...
import { getTeacher } from "@/lib/graphql/fetchers";
      ...
      <div className="w-full xl:w-2/3">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full sm:w-[48%] xl:w-[45%] 2xl:w-[48%] truncate">
              <Image src="/singleClass.png" alt="" width={24} height={24} className="w-6 h-6" />
              <div className="min-w-0">
                <h1 className="text-xl font-semibold truncate">
                  {teacher.classes.join(", ") || "-"}
                </h1>
                <span className="text-sm text-gray-400">Class list</span>
              </div>
            </div>
            <div className="bg-white p-4 rounded-md flex gap-4 w-full sm:w-[48%] xl:w-[45%] 2xl:w-[48%]">
